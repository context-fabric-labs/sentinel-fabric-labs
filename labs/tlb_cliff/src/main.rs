...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Print summary
    println!("TLB Cliff Lab Results:");
    println!("  Access Pattern: {}", result.access_pattern);
    ...
    println!("  TLB Misses: {}", result.tlb_misses);
    println!("  Page Walks: {}", result.page_walks);
